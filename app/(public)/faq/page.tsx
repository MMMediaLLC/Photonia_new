...
const FAQS = [
  {
    ...
    a: "Добиваш оригинална HD фотографија без воден жиг, во целосна резолуција (обично над 4000 пиксели по долгата страна). Сликата се испраќа како дигитално преземање во JPG формат, со вграден sRGB профил на бои. Нема физичка испорака.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    a: "Сликите се испорачуваат во JPG формат, оригинална резолуција (типично 4000 до 6000 пиксели по долгата страна), бојна профил sRGB, соодветни за печат до A2 формат при 300 DPI, и за сите дигитални употреби. Воденот жиг е отстранет на оригиналот кој го преземаш.",
  },
  {
    icon: Shield,
