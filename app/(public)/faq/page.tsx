...
const FAQS = [
  ...
  },
  {
    ...
    a: "По плаќањето добиваш е-пошта со директни линкови за преземање за секоја купена фотографија. Секој линк важи 30 дена од купувањето. Зачувај ја фотографијата локално веднаш по преземањето.",
  },
  {
    icon: CreditCard,
    q: "Како да платам?",
