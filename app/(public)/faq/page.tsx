...
const FAQS = [
  ...
  },
  {
    ...
    a: "По плаќањето добиваш е-пошта со директни линкови за преземање за секоја купена фотографија. Линковите важат една година од купувањето и можеш да ги отвораш до два пати по фотографија. Зачувај ја фотографијата локално веднаш по преземањето.",
  },
  {
    icon: CreditCard,
    q: "Како да платам?",
  ...
  },
  {
    ...
    a: "Прво провери ја папката Нежелена пошта (Spam). Ако и таму нема, пиши ни на support@photonia.mk со е-поштата и приближното време на купувањето — ќе ти го испратиме мејлот повторно во најкус можен рок.",
  },
  {
    icon: CheckCircle,
    q: "Мора ли да се регистрирам за да купам?",
    a: "Не. Не е потребна регистрација. При плаќање внесуваш само е-пошта, а линковите за преземање ти доаѓаат на истата е-пошта. Чувај го мејлот — тој е твојот пристап до купените фотографии.",
  },
  {
    icon: UserX,
