...
const FAQS = [
  ...
  },
  {
    ...
    a: "По плаќањето добиваш е-пошта со директни линкови за преземање за секоја купена фотографија. Секој линк важи една година од купувањето и дозволува до 2 преземања по фотографија. Зачувај ја фотографијата локално веднаш по преземањето.",
  },
  {
    icon: CreditCard,
    q: "Како да платам?",
