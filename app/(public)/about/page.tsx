  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose-like flex flex-col gap-6 text-[#ccc] leading-relaxed mb-14">
        ...
        <p>
          Photonia.mk е дигитален пазар за тие слики. Наместо да останат во архива,
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-14">
        {[
          ...
          },
          {
            ...
            desc: "Сите слики со препознатливи лица се означени со Editorial Only и имаат соодветни ограничувања за употреба.",
          },
          {
            icon: Globe,
      ...
      <div className="border border-white/[0.08] rounded-card p-6 mb-10">
        ...
        <ul className="flex flex-col gap-3 text-sm text-[#ccc]">
          {[
            ...
            "Не се врши дигитална манипулација која го менува фактичкиот контекст на сликата.",
